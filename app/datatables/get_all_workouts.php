                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <a class="btn btn-success" href="workout.php?action=delete&delete_id='.$d.'">Okay</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>';

            $edit = '<a href="workout.php?action=edit&edit_id='.$d.'" class="btn btn-info btn-sm mr-1 mb-1"><i class="fas fa-edit"></i></a>';
            $view = '<a href="workout.php?action=view&view_id='.$d.'" class="btn btn-success btn-sm mr-1 mb-1"><i class="fas fa-eye"></i></a>';
