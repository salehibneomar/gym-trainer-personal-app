...
$healthIssueData     = $healthIssue->readByClient($clientId);
$bodyMeasurementData = $bodyMeasurement->readByClient($clientId);
                            ...
                            <div class="tab-content">
                                <div class="active tab-pane" id="my-profile">
                                    <div class="w-100 text-center mb-4">
                                        ...
                                        <h5 class="text-uppercase"><span class="badge badge-light"><?=$_SESSION['user']['gym_name'];?></span></h5>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mx-auto">
                                                <ul class="list-group list-group-flush mb-3">
                                                    ...
                                                    <li class="list-group-item p-3">
                                                        <b class="d-inline-block">Account creation date</b>
                                                        <span class="d-inline-block float-right">
                                                            <?php
                                                            echo date('d M Y', strtotime($_SESSION['user']['acc_creation_date']));
                                                            ?>
                                                        </span>
                                                    </li>
                                                    <?php if($healthIssueData!=null){ ?>
                                                        <li class="list-group-item p-3 mt-3">
                                                            <p class="mb-3 p-0"><b>Health Issue:</b></p>
                                                            <?=$healthIssueData->issue; ?>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if($bodyMeasurementData!=null){ ?>
                                                        <li class="list-group-item p-3 mt-3">
                                                            <p class="mb-3 p-0"><b>Body Measurements:</b></p>
                                ...
                                <div class="tab-pane" id="pro-pic">
                                    ...
                                    <form method="post" class="row" action="client-profile.php?action=update_propic" enctype="multipart/form-data">
                                ...
                                <div class="tab-pane" id="general">
                                    ...
                                    <form method="post" class="row" action="client-profile.php?action=update_gnrl">
                                        <div class="form-group col-md-12">
                                            <label>Name <span class="text-danger">*</span></label>
                                            <input class="form-control" type="text" name="name" minlength="3" maxlength="60" value="<?=$_SESSION['user']['name']; ?>" required>
                                        </div>
                                ...
                                <div class="tab-pane" id="pass">
                                    ...
                                    <form method="post" class="row" action="client-profile.php?action=update_pwd">
                                        <div class="form-group col-md-12">
    ...
    if($action=='update_propic'){
            ...
            if(!empty($imageName) && $imageSize>0){
                if(in_array($imageExt, $validImageExt)){
                    if($imageSize<=$validImageSize){
                        $finalImageName = strtolower($_SESSION['user']['phone']."_r".rand(1000, 9999)."_dt".date('YmdHis')."_".str_replace(" ","_",$imageName));
                        ...
                        $result = $client->updateProfilePicture($clientId, $imageData);
        ...
        if($_SERVER['REQUEST_METHOD']=='POST'){
            ...
            if(empty($errors)){
                ...
                $result = $client->updatePassword($clientId, $password);
                if($result== -1){
        ...
        if($_SERVER['REQUEST_METHOD']=='POST'){
            ...
            else if(mb_strlen($_POST['name'])<3 || mb_strlen($_POST['name'])>60){
                array_push($errors, 'Name size should be between 3 and 60 characters!');
            }
            ...
            if(empty($errors)){
                ...
                $result = $client->updateGeneral($clientId, $generalUpdateData);
