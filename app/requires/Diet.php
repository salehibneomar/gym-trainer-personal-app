...
{
    private $conn;
    private $tableName = "diets";
    private $viewName  = "diets_view";
    ...
    {
        $result = false;
        $query = "UPDATE ".$this->tableName." SET d_status='archived' WHERE d_status='active' AND client_id= :client_id LIMIT 1";
        try{
    ...
    public function update($id, $data)
    {
        ...
        if(array_key_exists('d_status', $data) && $data['d_status']=='active'){
